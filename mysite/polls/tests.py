...
class QuestionModelTests(TestCase):
	def test_was_published_recently_with_future_question(self):
		""" was_publised recently() returns False for question whose pub_date is in the future """
...
class QuestionIndexViewTests(TestCase):
	...
	def test_future_question(self):
		""" Questions with a pub_date in the future aren't displayed on the index age. """
...
class QuestionResultsViewTests(TestCase):
	def test_result_no_choice(self):
		new_question = create_question(question_text='Some question', days=-1)
